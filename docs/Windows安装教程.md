...
>
> 
> powershell -ExecutionPolicy Bypass -Command "& { Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/LDPrompt/lingque/main/scripts/install-source.ps1' -OutFile '$env:TEMP\install.ps1'; & '$env:TEMP\install.ps1' }"
> 
